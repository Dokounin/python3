...
# réponse 3.3
candies_par_person = candies // friends
print(candies_par_person)

chocolates_par_person = chocolates // friends
print(chocolates_par_person)
# exo 3.4
...
# réponse 3.8
price_tva = price + price * tax_rate / 100
print(price_tva)
# exo 3.9
